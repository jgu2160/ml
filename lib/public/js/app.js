  ...
  return [
    m(".row", [
      m(".large-12.columns", [
        ...
        m("div", {class: "scatter"}),
        m("h1", {id: "blurb"}, "Upload a CSV, and Viduus will find the best model for your data, cleary displayed so you can quickly pinpoint insights about your data."),
...
var uploadFile = {
  view: function() {
    return mixinLayout(layout, dashNav, dashBody, "white");
  }
};
