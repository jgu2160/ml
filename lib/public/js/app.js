        ...
        m(".small-12.columns", [
          m("ul.accordion[data-accordion='']", [
            m("li.accordion-navigation", [
              m("a[href='#panel1a']", {href: "#panel1a", onclick: makeBar}, "Accordions animate when opening and closing"),
              m(".content[id='panel1a']", [
                m("div", {class: "bargraph"}),
              ])
            ]),
            m("li.accordion-navigation", [
              m("a[href='#panel2a']", "They are also partially blended into the page background"),
              m(".content[id='panel2a']", "\n      Panel 2. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.\n    ")
            ]),
            m("li.accordion-navigation", [
              m("a[href='#panel3a']", "Long content just shows a scrollbar"),
              m(".content[id='panel3a']", [
                m("p", "What counts as \"long\" is defined by the max-height of the active content on line 45. In our case it's set at 60vh, which is 60% of the viewport height."),
                m("p", "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis alias delectus eos fugit deserunt maiores repellat quos temporibus cumque quo soluta iure, et, accusamus, nemo. Voluptatum molestiae quod laborum voluptatem."),
                m("p", "Doloribus sed perspiciatis quos eaque cupiditate nihil fuga veniam nisi. Ex assumenda consequuntur ipsum nemo quaerat et, repellat qui impedit, mollitia ut veniam eligendi possimus fuga! Accusamus sequi harum dignissimos."),
                m("p", "Dicta delectus rerum reiciendis molestias eligendi, magnam deleniti sit perspiciatis quam molestiae provident ea aliquid eum officia eius odit, atque accusamus ex nemo placeat eos voluptatum. Quasi ipsam, ea nam!"),
                m("p", "Incidunt doloribus similique, placeat, harum reprehenderit voluptate aliquam exercitationem obcaecati sequi. Dignissimos nam, corrupti quo eius officia distinctio enim vero optio expedita magnam assumenda illum, quae aut, ad omnis. A."),
                m("p", "Quae minima modi, rerum labore quos blanditiis incidunt tenetur ducimus aliquid placeat animi illo dicta porro, quisquam perferendis nobis consectetur saepe omnis esse iusto, dolorum qui eveniet? Ipsum, veniam veritatis?"),
                m("p", "Doloribus sed perspiciatis quos eaque cupiditate nihil fuga veniam nisi. Ex assumenda consequuntur ipsum nemo quaerat et, repellat qui impedit, mollitia ut veniam eligendi possimus fuga! Accusamus sequi harum dignissimos."),
                m("p", "Dicta delectus rerum reiciendis molestias eligendi, magnam deleniti sit perspiciatis quam molestiae provident ea aliquid eum officia eius odit, atque accusamus ex nemo placeat eos voluptatum. Quasi ipsam, ea nam!")
              ])
            ]),
